...
public class AtyWelcome extends AppCompatActivity implements ViewPager.OnPageChangeListener {
    ...
    private void initViews() {
        ...
        btnToSign = findViewById(R.id.btn_to_sign);
        btnToLogin = findViewById(R.id.btn_to_login);
        btnToSign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AtyWelcome.this, SignUpActivity.class);
        ...
        btnToLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AtyWelcome.this, LoginActivity.class);
                startActivity(intent);
            }
        });
    }
