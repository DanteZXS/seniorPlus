...
public class DBManager {
	...
	private static final String url = "jdbc:mysql://localhost/seniorplus?"
	...
	public void connectDB() {
		try {
			...
			MainWindow.getMainWindow().setShowMsg("connect seniorPlus mysql success");
			
		} catch (SQLException e) {
			MainWindow.getMainWindow().setShowMsg("connect seniorPlus mysql failed");
			e.printStackTrace();
		}
	}
